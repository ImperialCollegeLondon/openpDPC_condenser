# openpDPC_condenser <!-- omit in toc -->  
...
Table of Contents  
---
- [MM2\_pDPC - MicroManager 2 plugin for pDPC](#mm2_pdpc---micromanager-2-plugin-for-pdpc)
  - [Overview](#overview)
...
<p align="center">
<img src=docs/pDPC_in_Plugins_menu.PNG width="75%" title="pDPC in Plugins menu"/>
</p>  
...
<source type="video/mp4" src="docs/Live.mp4">
</video> 

_If video is not shown in browser, click [here](docs/Live.mp4) to download and view it._
...
<video width="100%" controls>
<source type="video/mp4" src="docs/Recon.mp4">
</video>

_If video is not shown in browser, click [here](docs/Recon.mp4) to download and view it._

### _**Cali**_

<video width="100%" controls>
<source type="video/mp4" src="docs/Cali.mp4">
</video>

_If video is not shown in browser, click [here](docs/Cali.mp4) to download and view it._

### _**LiveSplit**_ 

<video width="100%" controls>
<source type="video/mp4" src="docs/LiveSplit.mp4">
</video>

_If video is not shown in browser, click [here](docs/LiveSplit.mp4) to download and view it._
...
- Launch python process  
	...
	<video width="100%" controls>
	<source type="video/mp4" src="docs/launch_python_process.mp4"> 
	</video> 
	
	_If video is not shown in browser, click [here](docs/launch_python_process.mp4) to download and view it._

- Stop python process

	<video width="100%" controls>
	<source type="video/mp4" src="docs/stop_python_process.mp4"> 
	</video> 

	_If video is not shown in browser, click [here](docs/stop_python_process.mp4) to download and view it._

#### Parameters & Presets

<video width="100%" controls>
<source type="video/mp4" src="docs/params_presets.mp4"> 
</video> 

_If video is not shown in browser, click [here](docs/params_presets.mp4) to download and view it._
